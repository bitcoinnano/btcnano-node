...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the btcnano database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make btcnano-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btcnano-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ btcnano-node add wallet-service');
      console.log('    $ btcnano-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ btcnano-node remove wallet-service');
      console.log('    $ btcnano-node remove insight-api');
      console.log();
    });
