...
/**
 * Will return the path and default btcnano-node configuration. It will search for the
 * configuration file in the "~/.btcnano" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.btcnano');
  var defaultConfigFile = path.resolve(defaultPath, './btcnano-node.json');
