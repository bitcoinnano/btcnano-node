...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'btcnano-lib': '^' + bitcore.version,
    'btcnano-node': version
  }
};

/**
 * Will create a directory and btcnano.conf file for Btcnano.
 ...
 * @param {String} options.datadir - The btcnano database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/btcnano-node.json', configJSON);
      if (!isGlobal) {
 ...
 * btcnano configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the btcnano node configuration directory
 * @param {String} options.datadir - The path to the btcnano datadir
...
function create(options, done) {
  ...
  async.series([
    ...
    function(next) {
      // Setup the btcnano directory and configuration
