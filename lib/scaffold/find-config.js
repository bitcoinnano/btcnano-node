...
/**
 * Will return the path and btcnano-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'btcnano-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'btcnano-node.json'))
  };
}
